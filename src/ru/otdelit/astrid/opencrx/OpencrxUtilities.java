...
public class OpencrxUtilities extends SyncProviderUtilities {
	...
	public static final String PREF_SERVER_LAST_SYNC = IDENTIFIER
			+ "_last_server"; //$NON-NLS-1$

	public static final String PREF_SERVER_LAST_NOTIFICATION = IDENTIFIER
			+ "_last_notification"; //$NON-NLS-1$

	public static final String PREF_SERVER_LAST_ACTIVITY = IDENTIFIER
			+ "_last_activity"; //$NON-NLS-1$
	...
	public String getToken() {
		String defToken = Preferences.getStringValue(getIdentifier()
				+ PREF_TOKEN);
	...
	public long getDefaultCreator() {
		...
		String defCreatorString = Preferences
				.getStringValue(R.string.opencrx_PPr_defaultcreator_key);
