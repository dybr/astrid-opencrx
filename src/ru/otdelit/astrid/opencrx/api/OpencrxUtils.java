...
/**
 * 
 * Utility methods for parsing http response from OpenCRX. Guarantees that
 * InputStream will be closed after using.
 * 
...
public class OpencrxUtils {
	...
	public Pair<String, String> getProcessIdAndStateId(String url)
		...
		try {
			...
			return new Pair<String, String>(p.getProcessId(),
					p.getProcessStateId());
	...
	public int getWorkTimeInSeconds(String url, String resourceId)
			throws ApiServiceException {
		InputStream xml = null;
		try {
	...
	public void getOpencrxContacts(List<OpencrxContact> destination, String url)
			throws ApiServiceException {
		InputStream xml = null;
		try {
			xml = restClient.get(url, retryLogin, retryPassword);
	...
	private String getPropertySetAddress(InputStream xml)
			throws ApiServiceException {
		try {
			SAXParser parser = getParser();
	...
	public String createPropertySet(String url, String data)
			throws ApiServiceException {
		InputStream xml = null;
		try {
	...
	public String getReferencePropertyValueXri(String url)
			throws ApiServiceException {
		InputStream xml = null;
		try {
			xml = restClient.get(url, retryLogin, retryPassword);
	...
	public String getReferencePropertyAddress(String url)
			throws ApiServiceException {
		InputStream xml = null;
		try {
			xml = restClient.get(url, retryLogin, retryPassword);
	...
	public boolean getContactIdsFromResources(List<String> dest, String url)
			throws ApiServiceException {
		InputStream xml = null;
		try {
	...
	public boolean getFollowUpsAddNote(List<String> dest, String url,
			String transitionId) throws ApiServiceException {
		InputStream xml = null;
		try {
			...
			ActiviyFollowUpParser p = new ActiviyFollowUpParser(dest,
					transitionId);
	...
	public List<String> getActivityGroupXris(String url)
			throws ApiServiceException {
		InputStream xml = null;
		try {
			xml = restClient.get(url, retryLogin, retryPassword);
	...
	private boolean convertOpencrxActivitiesToJson(JSONArray destination,
			InputStream xml, OpencrxActivityProcessGraph graph)
			throws ApiServiceException {
		try {
			OpencrxActivityProcessState complete = graph
					.getStateByName("Complete");
	...
	private JSONObject convertOpencrxActivityToJson(InputStream xml,
	...
	public boolean getOpencrxActivities(JSONArray destination, String url,
			OpencrxActivityProcessGraph graph) throws ApiServiceException {
		InputStream xml = null;
		try {
			xml = restClient.get(url, retryLogin, retryPassword);
	...
	public JSONObject modifyActivity(String url, String modificationData,
			OpencrxActivityProcessGraph graph) throws ApiServiceException {
		InputStream xml = null;
		try {
			xml = restClient.put(url, modificationData, retryLogin,
					retryPassword);
	...
	public JSONObject getOpencrxActivity(String url,
			OpencrxActivityProcessGraph graph) throws ApiServiceException {
		InputStream xml = null;
		try {
			xml = restClient.get(url, retryLogin, retryPassword);
	...
	public boolean convertOpencrxCreatorsXmlToJson(JSONArray destination,
			String url) throws ApiServiceException {
		InputStream xml = null;
		try {
			xml = restClient.get(url, retryLogin, retryPassword);
			SAXParser parser = getParser();
	...
	public boolean convertOpencrxResourcesToJson(JSONArray ret, String url)
			throws ApiServiceException {
		InputStream xml = null;
		try {
			xml = restClient.get(url, retryLogin, retryPassword);
	...
	public JSONObject convertResourceToJson(String url)
			throws ApiServiceException {
		InputStream xml = null;
		try {
			xml = restClient.get(url, retryLogin, retryPassword);
	...
	public boolean getResourceAssignments(List<OpencrxResourceAssignment> ret,
			String url) throws ApiServiceException {
		InputStream xml = null;
		try {
			xml = restClient.get(url, retryLogin, retryPassword);
	...
	public JSONObject converOpencrxUserHomeToJson(String opencrxUrl,
			String xriUserHome) throws ApiServiceException {
		InputStream xml = null;
		try {
			String url = TextUtils.concat(opencrxUrl, xriUserHome, "/",
					retryLogin).toString();
	...
	public String createNewActivity(String url, String createParams)
			throws ApiServiceException {
		InputStream xml = null;
		try {
	...
	public static String createNewActivityParams(String title, String dueBy,
			int priority) {
	...
	public static String createNewReferencePropertyParams(String name,
			String reference) {
		StringBuilder ret = new StringBuilder();
	...
	public static String createReappplyActivityCreatorParams(
	...
	public static String createFollowUpParams(String name, String text,
			String transition) {
		StringBuilder ret = new StringBuilder();
	...
	public static String createActivityAddWorkRecordParams(String name,
			int hours, int minutes, Date startedAt, String resourceId) {
	...
	public boolean getActivityProcessTransitions(
			List<OpencrxActivityProcessTransition> dest, String url)
			throws ApiServiceException {
		InputStream xml = null;
		...
		try {
			...
			ActivityProcessTransitionParser p = new ActivityProcessTransitionParser(
					dest);
	...
	public boolean getActivityProcessStates(
			List<OpencrxActivityProcessState> dest, String url)
			throws ApiServiceException {
		InputStream xml = null;
	...
	/**
	 * Hash function for string. Ensures that result is greater than one
	 * (TASK_ID_NOT_SYNCED).
	 * 
	 * @param str
	 * @return
	...
	public static Date parseFromOpencrx(String opencrxDate)
	...
	private static SAXParser getParser() throws ParserConfigurationException,
			SAXException {
		if (xmlParser == null) {
	...
	private static SimpleDateFormat getProducteevDateFormat() {
		if (opencrxToProducteevTimeFormatter == null) {
			opencrxToProducteevTimeFormatter = new SimpleDateFormat(
	...
	private static SimpleDateFormat getOpencrxDateFormat() {
		if (opencrxTimeFormatter == null) {
			opencrxTimeFormatter = new SimpleDateFormat(
